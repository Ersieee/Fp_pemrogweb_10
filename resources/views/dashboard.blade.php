            ...
            <div class="history-table">
                ...
                <table class="rental-history">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <!-- Waktu Sewa: Ambil dari tanggal_sewa (sudah objek Carbon) -->
                            {{-- Ini akan menampilkan tanggal dan jam lengkap dari kolom tanggal_sewa --}}
                            <td>{{ $rental->tanggal_sewa->format('d-m-Y H:i') }}</td>

                            <!-- Durasi -->
                            <td>{{ $rental->durasi }} hari</td>

                            <!-- Waktu Mulai: Ambil dari jam_mulai (string H:i) -->
                            {{-- Ini akan menampilkan jam dan menit yang tersimpan di kolom jam_mulai --}}
                            <td>{{ $rental->jam_mulai }}</td>

                            <!-- Waktu Selesai: Ambil dari waktu_selesai (sudah objek Carbon) -->
                            {{-- Ini akan menampilkan tanggal dan jam lengkap dari kolom waktu_selesai --}}
